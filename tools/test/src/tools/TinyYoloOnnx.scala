...
object TinyYoloOnnx {
  val GoldenOutputFileNames = Map(
    "StatefulPartitionedCall/model/conv2d_17/BiasAdd:0" -> "../tensil-models/data/yolov4_tiny_192_conv17.csv",
    "StatefulPartitionedCall/model/conv2d_20/BiasAdd:0" -> "../tensil-models/data/yolov4_tiny_192_conv20.csv"
  )
