...
class Decoder(val arch: Architecture, options: TCUOptions = TCUOptions())(
  ...
  val dram0 = OutQueue(dram0Handler.io.in, 2)
  val dram1 = OutQueue(dram1Handler.io.in, 2)
  //// local
  ...
  val acc = OutQueue(accHandler.io.in, 2)
  //// array
  ...
  val array = OutQueue(arrayHandler.io.in, 2)
  //// router
  val dataflow = OutQueue(io.dataflow, 2)
  //// host router
  ...
  val hostDataflow = OutQueue(hostDataflowHandler.io.in, 2)
