...
object TinyYoloOnnx {
  val GoldenOutputFileNames = Map(
    "StatefulPartitionedCall/model/conv2d_17/BiasAdd:0" -> "tf_models/yolov4_tiny_192_conv17.csv",
    "StatefulPartitionedCall/model/conv2d_20/BiasAdd:0" -> "tf_models/yolov4_tiny_192_conv20.csv"
  )
  ...
  def prepareInputStream(
    ...
    val fileName = s"tf_models/yolov4_tiny_${count}x192x192x${arraySize}.csv"
